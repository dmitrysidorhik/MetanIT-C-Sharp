...
namespace _09_Перегрузка_операций_преобразования_типов
{
    class Timer
    {
    ...
    class Program
    {
        ...
        {
            Counter counter1 = new Counter { Seconds = 36781 };
            Timer timer = counter1;
            Console.WriteLine($"{timer.Hours} час : {timer.Minutes} минут : {timer.Seconds} секунд");
